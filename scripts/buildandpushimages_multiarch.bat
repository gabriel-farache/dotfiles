...
echo "building and pushing image git-prompt"
pushd source\output\dot_oh-my-zsh\plugins\git-prompt
docker buildx build --platform ${PLATFORMS} -f Dockerfile --push --tag ${REGISTRY_URL}/${REGISTRY_NAMESPACE}/git-prompt .
popd
