...
echo "pushing image git-prompt"
%CONTAINER_RUNTIME% tag git-prompt %REGISTRY_URL%/%REGISTRY_NAMESPACE%/git-prompt
%CONTAINER_RUNTIME% push %REGISTRY_URL%/%REGISTRY_NAMESPACE%/git-prompt
